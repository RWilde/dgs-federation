package com.thesting.cart.directive.evaluator;

import com.netflix.graphql.dgs.context.DgsContext;
import com.netflix.graphql.dgs.internal.DgsRequestData;
import com.thesting.cart.exception.AccessDeniedError;
 ...
 * 5. Else if security expression evaluates to <code>false</code>,an {@link com.thesting.cart.exception.AccessDeniedError} is thrown and resolver function of field is <b>not invoked</b>
 */
@Component
public class SecuredDirectiveWiring implements SchemaDirectiveWiring {
    ...
    public GraphQLObjectType onObject(SchemaDirectiveWiringEnvironment<GraphQLObjectType> environment) {
        ...
        String expressionValue = (String) field.getDirective(SECURED_DIRECTIVE).getArgument(REQUIRES_ATTR).getArgumentValue().getValue();
    ...
    public GraphQLFieldDefinition onField(SchemaDirectiveWiringEnvironment<GraphQLFieldDefinition> environment) {
        ...
        DataFetcher authDataFetcher = dataFetchingEnvironment -> {
            ...
            String expressionValue = (String) dataFetchingEnvironment.getFieldDefinition().getDirective(SECURED_DIRECTIVE).getArgument(REQUIRES_ATTR).getArgumentValue().getValue();
            DataFetcherResult.Builder<Object> resultBuilder = DataFetcherResult.newResult();
